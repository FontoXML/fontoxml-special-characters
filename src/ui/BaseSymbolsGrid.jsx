...
BaseSymbolsGrid.propTypes = {
	/**
	 * The characterSet to display, as used in {@link SpecialCharactersManager#addCharacterSet}. It
	 * should not be empty, so please handle empty characterSets before rendering this component.
	 */
